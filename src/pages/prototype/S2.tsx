...
import Pathway1Popover from "../../components/prototypes/s2/Pathway1Popover";
...
const prototypeS2 = () => {
  return (
    <>
        <Head>
        <title>prototype S 2</title>
        <meta name="prototype S2" content="Generated by create-t3-app" />
